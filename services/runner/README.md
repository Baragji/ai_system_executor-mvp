...
An Express + TypeScript scaffold for the executor runner microservice with OpenTelemetry bootstrap and RFC 9457 problem details responses. The runner will eventually host execution plan and single-step handlers extracted from the monolith.
...
Visit `http://localhost:3004/healthz` to verify the service is running.
