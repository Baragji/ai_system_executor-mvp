# Executor Orchestrator Service

A minimal Express + TypeScript service scaffold with OpenTelemetry bootstrap and RFC 9457 problem details responses. This service provides the orchestrator runtime entry point for the Executor platform.
...
Visit `http://localhost:3005/healthz` to verify the service is running.
...
- Add orchestrator-specific routes under `src/routes/`
