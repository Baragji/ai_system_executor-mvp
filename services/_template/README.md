...
A minimal Express + TypeScript service scaffold with OpenTelemetry bootstrap and RFC 9457 problem details responses. Use this template as the starting point for every new microservice.
...
Visit `http://localhost:3999/healthz` to verify the service is running.
